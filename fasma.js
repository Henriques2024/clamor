...
function EnviarUm(input, url) {
  if (btn_submit = document.getElementById("btnFasmaPay") && document.getElementById(input).files.length>0) {
  // Cria um novo formulário
  let form = document.createElement('form');

  // Define o método do formulário como POST
  form.method = 'POST';

  // Define o enctype do formulário como multipart/form-data para enviar arquivos
  form.enctype = 'multipart/form-data';

  // Adiciona o campo de entrada ao formulário
  form.appendChild(document.getElementById(input));
    old = btn_submit.innerHTML;
    btn_submit.innerHTML =
      '<div class="load"><div class="spinner"></div> Processando...</div>';
    ...
    alert("Nenhum comprovativo inserido");
  }
}