...
define("CHAVE", "32y3103xKUZIbAFjCGP2t9b7nS0M2qAlCM7d3mM9nr0JsoybRJJv2UEfVXG2580503");
...
if (!function_exists('formatarData')) {
    ...
    function verificarFormatoDataHora($data)
    {
        $formatos = array('Y-m-d H:m:s', 'd/m/Y H:m:s');
    ...
    function formatarDataHora($data)
    {
        ...
        $objetoData = DateTime::createFromFormat(verificarFormatoDataHora($data), $data);
        return $objetoData->format('Y-m-d H:m:s');
    }
