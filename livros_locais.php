...
<div class="container my-5">
    ...
    <div class="input-group mb-5 w-50 ms-auto">
        <input type="text" class="form-control" placeholder="Pesquisar livros..." aria-label="Pesquisar livros" aria-describedby="button-addon2">
        <button class="btn btn-outline-primary" type="button" id="button-addon2">Pesquisar</button>
    </div>
    <div class="row row-cols-1 row-cols-md-4 g-4">
        <div class="col">
            <div class="card h-100">
                <img src="https://via.placeholder.com/300x400" class="card-img-top" alt="Capa do Livro 1">
                <div class="card-body">
                    <h5 class="card-title">Livro 1</h5>
                    <p class="card-text">Descrição do Livro 1</p>
                    <a href="#" class="btn btn-primary">Comprar</a>
                    <a href="#" class="btn btn-outline-primary">Ler</a>
                </div>
            </div>
        </div>
        <div class="col">
            <div class="card h-100">
                <img src="https://via.placeholder.com/300x400" class="card-img-top" alt="Capa do Livro 2">
                <div class="card-body">
        ...
        <div class="col">
            <div class="card h-100">
                <img src="https://via.placeholder.com/300x400" class="card-img-top" alt="Capa do Livro 3">
                <div class="card-body">
                    <h5 class="card-title">Livro 3</h5>
                    <p class="card-text">Descrição do Livro 3</p>
                    <a href="#" class="btn btn-primary">Comprar</a>
                </div>
            </div>
        </div>
        <div class="col">
            <div class="card h-100">
                <img src="https://via.placeholder.com/300x400" class="card-img-top" alt="Capa do Livro 4">
                <div class="card-body">
                    <h5 class="card-title">Livro 4</h5>
                    <p class="card-text">Descrição do Livro 4</p>
                    <a href="#" class="btn btn-primary">Comprar</a>
                </div>
            </div>
        </div>
